...
public class ReflectUtils {
    ...
    public static <T> int getFieldModifier(Class<T> clazz, String field) {
        ...
        throw new BizRuntimeException(clazz + " has no field \"" + field + "\"");
    }
    ...
    public static <T> int getMethodModifier(Class<T> clazz, String method) {
        ...
        throw new BizRuntimeException(clazz + " has no method \"" + m + "\"");
    }

    /**
     * [对象]根据成员变量名称获取其值
     * @param clazzInstance 对象
     * @param field 属性
     * @param <T> 泛型
     * @return 变量值
    ...
    public static <T> Object getFieldValue(Object clazzInstance,
            Object field) throws NoSuchFieldException, SecurityException,
     ...
     * @throws Exception
     */
    public static <T> Field[] getClassFieldsAndSuperClassFields(
            Class<T> clazz) {
